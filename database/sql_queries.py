...
# (
# ID INTEGER PRIMARY KEY,
# DIS_OWNER_TELEGRAM_ID INTEGER,
# DISLIKER_TELEGRAM_ID INTEGER,
# UNIQUE (DIS_OWNER_TELEGRAM_ID, DISLIKER_TELEGRAM_ID)
# )
# """
#
...
# """
#
# FILTER_DISLEFT_JOIN_PROFILE_QUERY = """
# SELECT * FROM profile
# LEFT JOIN dislike_profile ON profile.TELEGRAM_ID = dislike_profile.DIS_OWNER_TELEGRAM_ID
...
CREATE_REFERENCE_USERS_QUERY = """
CREATE TABLE IF NOT EXISTS referral
(
ID INTEGER PRIMARY KEY,
REF_OWNER_TELEGRAM_ID INTEGER,
REFERRAL_TELEGRAM_ID INTEGER,
UNIQUE (REF_OWNER_TELEGRAM_ID, REFERRAL_TELEGRAM_ID)
)
"""
...
FROM
    telegram_users
LEFT JOIN
    referral ON telegram_users.TELEGRAM_ID = referral.REF_OWNER_TELEGRAM_ID
WHERE 
